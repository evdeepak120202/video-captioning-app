...
import { ArrowLeft, Code, Video, Languages, Palette, Download, Zap, Mail, ExternalLink, CheckCircle2, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-16">
        <Link href="/editor" className="inline-flex items-center text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 mb-8 transition-colors group">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow">
            ...
            <CardContent className="space-y-3 text-slate-700 dark:text-slate-300">
              <div className="flex items-start gap-3">
                <div className="h-2 w-2 rounded-full bg-indigo-600 dark:bg-indigo-400 mt-2 flex-shrink-0" />
        ...
        <Card className="mb-12 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm shadow-lg">
          ...
          <CardContent className="text-slate-700 dark:text-slate-300 space-y-4 leading-relaxed">
            ...
            <div>
              <p className="font-semibold mb-2">Why Remotion?</p>
              <p className="text-sm">
                Remotion is built for programmatic video generation, which is exactly what we need here. It lets me 
                overlay captions on videos with precise timing, and the preview works in the browser which is great for UX.
              </p>
            </div>
            <div>
              <p className="font-semibold mb-2">Why the render script approach?</p>
              <p className="text-sm">
                Vercel's serverless functions have a 10-second timeout on the free tier (60 seconds on Pro). Video rendering 
                can take much longer than that. So instead of trying to render on the server, I generate a script that you 
                run locally. It's more reliable and doesn't cost anything extra.
              </p>
            </div>
          </CardContent>
        </Card>
